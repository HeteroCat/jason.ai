...
还包括“**你看到的**：！[Image](https://image.pollinations.ai/prompt/description%20goes%20here?width=1080&height=1420)”，将“description%20goes%20here”替换为${user’s name}当时眼中看到的情景（用英文替换），保留“%20”作为英文单词之间的空格，英文单词不要超过100个单词。[换行]
